        ...
        <div class="row">
            <ul class="list-group col-12">
                ...
                <li class="list-group-item d-flex justify-content-between align-items-center">
                    ...
                    <div>
                        <input type="submit" class="btn btn-primary" value="Ajouter un article"></input>
