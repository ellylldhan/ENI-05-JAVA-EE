 ...
 */
@WebServlet("/modules/module2/ServletAvecParametreInitialisationWebXML")
...
//		response.getWriter().append("Served at: ").append(request.getContextPath());
		response.getWriter().append("Parametre = ").append(this.getInitParameter("NOM_PARAMETRE")).append(" - Served at: ").append(request.getContextPath());
