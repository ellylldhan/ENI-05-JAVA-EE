...
/* Modification Aur�lien Martineau ajout Singleton et modification du serialVersionUID */
...
public class ServletAjoutRepas extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if (listeCodesErreur.size() > 0) {
			...
			// avec Singleton
			RepasManager repasManager = RepasManager.getInstance();
			try {
				...
				// Sinon je retourne � la page d'ajout pour indiquer les probl�mes:
				e.printStackTrace();
