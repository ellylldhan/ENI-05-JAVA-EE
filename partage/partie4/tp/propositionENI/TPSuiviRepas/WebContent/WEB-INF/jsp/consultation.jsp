						...
						<tbody>
							...
							%>
								<tr>
									...
									{
										%>
										<a href="<%=request.getContextPath()%>/repas?dateFiltre=<%=dateFiltre%>">détail</a>	
										<%								
									}
									else
									{
										%>
										<a href="<%=request.getContextPath()%>/repas?detail=<%=repas.getIdentifiant()%>&dateFiltre=<%=dateFiltre%>">détail</a>	
										<%	
									}
									%>
