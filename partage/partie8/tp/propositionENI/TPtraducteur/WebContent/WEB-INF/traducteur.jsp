	...
	<form method="POST" action="${pageContext.request.contextPath}/ServletChangerLangue">
		<p>
			<select name="langueinitiale" onchange="document.forms[0].submit();">
				...
				<option value="de" ${sessionScope.langueinitiale=='de'?'selected':''}>Deutsch</option>
			</select>
			...
			<select name="languecible" onchange="document.forms[0].submit();">
				...
				<option value="de" ${sessionScope.languecible=='de'?'selected':''}>Deutsch</option>
			</select>
		<p>
		<p>
					<input type="submit"  formaction="${pageContext.request.contextPath}/CollabCommunaute" value="Collaboration communautaire" />
		</p>
	</form>
