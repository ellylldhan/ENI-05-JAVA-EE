...
function loadNotes() {
	$.getJSON("http://localhost:8080/TPPriseDeNotes/rest/notes",
			  function(data) {
...
function updateNote(id) {
	...
	$.ajax({
		type:"PUT",
		url:"http://localhost:8080/TPPriseDeNotes/rest/notes/".concat(id),
...
function ajouterNote() {
	...
	$.ajax({
		type:"POST",
		url:"http://localhost:8080/TPPriseDeNotes/rest/notes/",
		data: {paramContenu: contenu},
		success: function(result) {
			loadNotes();
		}
